...
const CourtGrid = ({ slot, onSlotClick }) => {
  ...
  // Court layout: Singles Courts (0,1,2) and Doubles Courts (3,4,5)
      ...
      <div className="grid grid-cols-2 gap-6 court-grid">
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-2 mb-4">
            ...
            <h4 className="text-lg font-bold text-gray-800">Singles Courts</h4>
          ...
          <div className="space-y-2">
            {singlesCourts.map((courtIndex) => {
              ...
              const subCourt = slot.subCourts?.find(s => s.index === courtIndex);
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-2 mb-4">
            ...
            <h4 className="text-lg font-bold text-gray-800">Doubles Courts</h4>
